...
describe('Nota routing resolve service', () => {
  ...
  let routingResolveService: NotaRoutingResolveService;
  let service: NotaService;
  let resultNota: INota | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(NotaRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new INota if id is not provided', () => {
      // GIVEN
      ...
      expect(resultNota).toEqual(new Nota());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Nota })));
      mockActivatedRouteSnapshot.params = { id: 123 };
